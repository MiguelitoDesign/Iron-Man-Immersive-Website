    ...
    const handleScroll = () => {
      ...
      requestAnimationFrame(() => {
        ...
        if (bigLeftTextRef.current) {
          ...
          if (progress >= 0.1) {
            document.documentElement.classList.add("theme-blue-hero");
          } else {
            document.documentElement.classList.remove("theme-blue-hero");
          }
        }
      ...
      >
        ...
        >
          ...
          <p className="max-w-[42ch] font-sans text-sm leading-relaxed text-zinc-400 md:text-base">
            ...
            system diagnostic — F.R.I.D.A.Y. is holding on the line.
          </p>
        </div>
        ...
        >
          ...
          <h2 className="font-sans font-semibold leading-[0.88] tracking-tighter text-foreground text-[clamp(4rem,9.5vw,9rem)]">
            Build
            <br />
            with <span className="text-accent">GEMINI</span>
          </h2>
        ...
        <div className="pointer-events-none absolute inset-x-0 bottom-0 z-10">
          ...
          <div className="mx-6 flex items-center justify-between pb-4 font-mono text-[10px] uppercase tracking-[0.28em] text-zinc-500 md:mx-10">
            ...
            <span>F.R.I.D.A.Y. // DIAGNOSTIC</span>
